"use strict";Object.defineProperty(exports, "__esModule", {value: true}); function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } }// src/transport.ts
...
var WebsocketTransport = class {
  ...
  async reconnect(timeoutIndex = 0) {
    let timeout = (_nullishCoalesce(timeouts[timeoutIndex], () => ( timeouts[timeouts.length - 1]))) + (Math.floor(Math.random() * 5e3) + 1);
    setTimeout(() => {
...
exports.Client = Client; exports.FetchTransport = FetchTransport; exports.NoOpTransport = NoOpTransport; exports.RSPCError = RSPCError; exports.WebsocketTransport = WebsocketTransport; exports.createClient = createClient; exports.randomId = randomId;
